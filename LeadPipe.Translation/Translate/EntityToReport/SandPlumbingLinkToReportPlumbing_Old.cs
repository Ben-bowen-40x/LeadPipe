...
internal partial class SandPlumbingLinkToReportPlumbing_Old : IEntityToReport<SandPlumbingLink, ReportPlumbing_Old>
{
    private const string dateFormat = "yyyy-MM-dd HH:mm:ss";
    public ReportPlumbing_Old Translate(SandPlumbingLink link)
    {
