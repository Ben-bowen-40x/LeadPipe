...
internal sealed class AttributionResultToReportYellerOld(IYellerSettings settings) : IEntityToReport<AttributionResult, ReportYeller_Old>
{
    private readonly string _action = settings.YellerActionSource!;
    public ReportYeller_Old Translate(AttributionResult result)
    {
