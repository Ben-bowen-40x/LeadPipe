...
public class CaliperMySqlRepositoryTests
{
    ...
    {
        CaliperMySqlRepository repo = CreateRepo(out var ctx, nameof(GetByIdAsync_Returns_Entity_With_Details_When_Requested));
    ...
    {
        CaliperMySqlRepository repo = CreateRepo(out var ctx, nameof(GetByIdAsync_Returns_Entity_Without_Details_When_Disabled));
    ...
    {
        CaliperMySqlRepository repo = CreateRepo(out _, nameof(GetByIdAsync_Returns_Failure_When_Not_Found));
    ...
    {
        CaliperMySqlRepository repo = CreateRepo(out var ctx, nameof(FindAsync_Filters_Correctly));
