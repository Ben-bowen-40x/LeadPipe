...
public class TransformYellerReportComprehensiveTests
{
    ...
    public TransformYellerReportComprehensiveTests()
    {
    ...
    [Fact]
    public async Task TransformAsync_ComplexScenario_WorksCorrectly()
    {
        // Arrange
