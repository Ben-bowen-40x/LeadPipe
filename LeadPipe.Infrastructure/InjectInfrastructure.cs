...
public static class InjectInfrastructure
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IInfrastructureSettings settings, IConfiguration config)
    {
        ...
        services.AddScoped<IDataPersistence<CornEntity>, CornEntityPersistence>();
        ...
        services.AddScoped<IDataPersistence<CornFormula>, CornFormulaPersistence>();
        ...
        services.AddScoped<IUpdateService<CornFormula>, CornUpdateService>();
        ...
        services.AddScoped<IReport<ReportYeller>, YellerCsvReporterAsync>();
